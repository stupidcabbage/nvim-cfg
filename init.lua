...
vim.o.list = true
vim.opt.tabstop = 2 -- 1 таб = 5 пробелов
...
vim.o.confirm = true -- Confirm q without saving
...
-- C++
vim.keymap.set('n', '<F5>', ':!g++ % --std=c++26 -o %:r && ./%:r<CR>', { silent = true })
